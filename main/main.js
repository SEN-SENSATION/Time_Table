...
var colorSchemeToggle = document.getElementById("color-scheme-toggle");
window.matchMedia("(prefers-color-scheme: dark)").matches
  ? ((colorSchemeToggle.innerHTML = "dark_mode"),
    document.documentElement.setAttribute("color-scheme", "dark"),
    null !== localStorage.getItem("colorScheme") &&
      localStorage.setItem("colorScheme", "dark_mode"))
  : ((colorSchemeToggle.innerHTML = "light_mode"),
    null !== localStorage.getItem("colorScheme") &&
      localStorage.setItem("colorScheme", "light_mode")),
  colorSchemeToggle.addEventListener("click", function () {
    var e =
      "light_mode" === colorSchemeToggle.innerHTML ? "dark_mode" : "light_mode";
    (colorSchemeToggle.innerHTML = e),
      localStorage.setItem("colorScheme", e),
      "dark_mode" === localStorage.getItem("colorScheme")
        ? document.documentElement.setAttribute("color-scheme", "dark")
